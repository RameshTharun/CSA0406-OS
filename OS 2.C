...
int main() {
    ...
    printf("Enter the full directory path to open for reading (e.g., C:\\Users\\CM\\Desktop):\n");
    ...
    printf("Enter the full directory path to open for writing (e.g., C:\\Users\\CM\\Desktop):\n");
